...
import BottomWarnModal from "./BottomWarnModal"
...
export default function Bottom() {
  ...
  useEffect(() => {
    ...
    const targetDate = new Date("2024-05-28")

    setIsWarningModalOpen(currentDate.getTime() >= targetDate.getTime())
  }, [])

  return (
    <>
      <section className="flex bg-neutral-200 items-center justify-around pt-10 pb-10">
        <button
          type="button"
          aria-label="공유하기"
          onClick={() => {
